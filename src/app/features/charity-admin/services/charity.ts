...
import { CreateCharityRequest, ApiResponse, UpdateCharityInfoRequest, UpdateCharityLocationRequest, Donation, Volunteer, Charity } from '../interfaces/charity-admin-interface';
