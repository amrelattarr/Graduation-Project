...
import { charityApprovalGuard } from './core/guards/charity-approval.guard';
...
import{ Charities } from './features/admin/components/charties/charties';
...
export const routes: Routes = [
    ...
    {path: 'home-page', component: HomePage, title: 'Home page'},
    ...
    {path: '' , component: AdminLayout,canActivate:[authGuard, roleGuard], data: { roles: ['Admin'] } , children: [
        {path: 'charties' , component: Charities , title: 'Charties page'},
